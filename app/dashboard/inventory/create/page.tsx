...
export default function CreateProductPage() {
    ...
    const handleSaveProduct = async () => {
        ...
        try {
            ...
            const response = await apiClient.post("/api/inventory", {
                name: productName,
    ...
    const hasChanges = productName || description || sku || category || sellingPrice;
                ...
                <Flex justify="space-between" align="center" flexWrap="wrap" gap={4}>
                    ...
                    <HStack gap={2}>
                        <Button
                            variant="outline"
                            size="sm"
                            onClick={() => hasChanges ? setDiscardDialogOpen(true) : router.push("/dashboard/inventory")}
                        >
                            Cancel
                        </Button>
                        <Button
                            ...
                            <Card.Root border="1px solid" borderColor="border.default" bg="bg.surface">
                                ...
                                <Card.Body p={5}>
                                    <SimpleGrid columns={{ base: 1, md: 3 }} gap={4}>
                                        <Field.Root>
                                            <Field.Label fontSize="sm">Initial Stock</Field.Label>
                                            <Input
                                                type="number"
                                                placeholder="0"
                                                size="sm"
